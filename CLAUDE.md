...
- Python 3.10+ (for ROS 2 Humble/Iron compatibility), Markdown for documentation + ROS 2 Humble or Iron, NVIDIA Isaac Sim, Isaac ROS, Nav2, rclpy, robot_state_publisher, joint_state_publisher, RViz2, Docusaurus v3+ (001-isaac-robot-brain)
- Python 3.10+ (as specified in project constitution for ROS 2 compatibility), JavaScript/TypeScript for frontend components + FastAPI, OpenAI SDK, Qdrant client, LangChain, React for Docusaurus integration (001-rag-chatbot)
- Qdrant Cloud (vector database), with optional Neon Serverless Postgres for user/chat history (001-rag-chatbot)
